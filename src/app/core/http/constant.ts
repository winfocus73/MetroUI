export class Constants {
    ...
    static assetUnderMonitoringRemarkUpdateError = 'AssetS under monitoring adding/updating failed';
    static assetUnderMonitoringRemarkUpdateSuccess = 'AssetS under monitoring remark updated successfully';
    ...
    static meterError = 'Meter readings saving failed';
        ...
        static ReturnApprovePTWSuccess='Retuen PTW Approval request Approved successfully';
        ...
        static workOrderRestrictCancel = ' This workorder cancellation is not allowed as the associted PTW is either started or completed.';
        ...
        static NXASM_CONFIG_SETUP_WORK_FLOW_FILTER = "NXASM_CONFIG_SETUP_WORK_FLOW_FILTER";
        static NXASM_CONFIG_MAINTENANCE_ASSET_PART_TYPES_FILTER= "NXASM_CONFIG_MAINTENANCE_ASSET_PART_TYPES_FILTER";
        static CONFIG_MAINTENANCE_ASSET_PART_TYPES = "CONFIG_MAINTENANCE_ASSET_PART_TYPES";
        static STAFF_QUALIFICATION_LIST_FILTER_OBJECT = "staffQualificationListFilterOptions";
